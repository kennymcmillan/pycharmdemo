...
selected_row = df[(df['competition_name'] == selected_competition) & (df['season_name'] == selected_season) & (
            df['competition_gender'] == selected_gender)]
...
filtered_df_4 = data_selected[
    data_selected["home_team_name"].isin([selected_team]) | data_selected["away_team_name"].isin([selected_team])]

match_descriptions = [row['home_team_name'] + " v " + row['away_team_name'] + " : " + row['competition_stage_name'] for
                      index, row in filtered_df_4.iterrows()]
...
filtered_df_4['match_bool'] = (filtered_df_4['home_team_name'].str.contains(home_team)) & (
    filtered_df_4['away_team_name'].str.contains(away_team)) & (
                                  filtered_df_4['competition_stage_name'].str.contains(competition_round))
